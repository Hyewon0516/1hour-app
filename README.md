...
```
1hour-app/
├── app.js                # Express 서버 메인 파일 (카카오 OAuth 처리)
├── index.html           # 기업 홈페이지 (Tailwind CSS 디자인)
├── kakao.html          # 카카오 로그인 페이지
...
- REST API 테스트 기능
- 사용자 정보 조회, 로그아웃, 연결 해제 기능

## 🎨 UI/UX 특징

- **기업 홈페이지**: cndfactory 브랜드의 전문적인 SI 솔루션 소개
- **모던한 디자인**: Tailwind CSS를 활용한 깔끔하고 직관적인 인터페이스
- **반응형 레이아웃**: 모든 디바이스에서 최적화된 사용자 경험
- **카카오 로그인**: 전용 로그인 페이지와 API 테스트 기능
- **부드러운 애니메이션**: 사용자 경험 향상을 위한 인터랙션
